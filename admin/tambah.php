...
<body class="font-[Onest]">
    ...
    <div id="navbar"></div>
    <h1 class="justify-center mt-20 mx-auto flex font-bold text-4xl">Tambah Pembeli</h1>    
            ...
            <ul>
                <li>
                    <label for="tanggal_pesan"> Tanggal Pesan :
                        <input type="text" name="tanggal_pesan" id="tanggal_pesan" class="w-full border-1 border-slate-800 rounded-lg hover:border-slate-500 px-2" required>
                    </label>
                </li>
                 <li class="mt-5">
                    <label for="Nama"> Nama Pemesan :
                        <input type="text" name="nama" id="Nama" class="w-full border-1 border-slate-800 rounded-lg hover:border-slate-500 px-2" required>
                    </label>
                </li>
                  <li class="mt-5">
